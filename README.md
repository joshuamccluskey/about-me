...
The most impactful way for me to learn is to learn things that will have an impact on my day to day. I originally got into coding due to the ability to automate my daily tasks at work to make more time for myself instead of doing very monotonous tasks. The same is true while at Code Fellows. Every time that I learn a new skill or ability and apply it right away, I learn that using what you learn right away is the best way to learn. Building upon my previous experiences has helped me to find the right thing that I need and can use to solve a problem. I find it applicable to most aspects of life in order to grow and learn. What I love the most is leaning form many different people because everyone has something they use that could be useful to you. Its really amazing to see the collaborative side of learning.
